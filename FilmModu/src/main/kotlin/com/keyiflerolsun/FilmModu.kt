...
class FilmModu : MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        alternates.forEach { altLinkElement ->
            ...
            if (altLink == null || altName.contains("Fragman", true)) return@forEach
